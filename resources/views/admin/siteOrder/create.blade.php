...
<x-card>
	<div class="row">
		<div class="col-md-12">
			<h4 class="display-4">Nueva orden de servicio en sitio</h4>
		</div>
	</div>
	<div class="row">
		<hr class="my-2">
	...
	<form action="{{ route('orderSite.store', $client->slug) }}" method="POST">
		@csrf
		...
		<div class="row">
			...
			<div class="form-group col-md-3 mb-0">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="Anticipo" id="advance" name="advance" value="{{ old('advance') }}">
					<div class="input-group-append">
						<span class="input-group-text">.00</span>
					</div>
				</div>
