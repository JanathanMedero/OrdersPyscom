			...
			<div id="newProduct">
				...
				<div class="form-group col-md-3 mb-0">
					<div class="input-group">
						...
						<input type="text" class="form-control" placeholder="Ingrese el precio unitario" name="unit_price" value="{{ $product->unit_price }}">
				...
				<div class="form-group col-md-3 mb-0">
					<div class="input-group">
						...
						<input type="text" class="form-control" placeholder="Ingrese el precio total NETO" name="net_price" value="{{ $product->net_price }}">
						<div class="input-group-append">
							<span class="input-group-text">.00</span>
						</div>
					</div>
